(() => {
  ...
  function couponIconHtml(title){
    ...
    return '<img class="title-coupon-icon" src="assets/title-coupon.png?v=13.5" alt="" aria-hidden="true" title="Available from Instance Dungeon Guaranteed Titlebook Coupon II">';
  }
